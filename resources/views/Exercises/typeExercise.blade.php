        ...
        <div class="card">
            <div class="card-header">
                <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                    <li class="nav-item">
                        <a class="nav-link" href="{!! route('exercises.index') !!}"><i class="fa fa-list mr-2"></i>Lista de Tipos de
                            Ejercicio</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="card-body">
                <div class="row my-5 justify-content-center">
                    <form name="exercise-type-form" id="exercise-type-form" action="#" method="POST" class="col-md-8">
                        @csrf
