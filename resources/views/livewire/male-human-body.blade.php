<div>
    <div class="hidden sm:flex">
        <div class="flex justify-center 2xl:flex-nowrap gap-x-2">
            <div class="row">
                <div class="col-md-6 form-group mb-3">
                    {{-- parte frontal --}}
                    <svg viewBox="0 0 660.46 1206.46" fill="none" xmlns="http://www.w3.org/2000/svg"
                        class="w-full h-[38rem]">
                        <defs>
                            <radialGradient id="jointradial" cx="50%" cy="50%" r="50%" fx="50%"
                                fy="50%">
                        ...
                        <g id="calves" class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                        ...
                        <g id="quads" class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                            onclick="changeColor(this)">
                            <path
                        ...
                        <g id="abdominals" class="bodymap active:text-mw-red-700 text-mw-red"
                            onclick="changeColor(this)">
                            <path
                        ...
                        <g id="obliques" class="bodymap active:text-mw-red-700 text-mw-red"
                            onclick="changeColor(this)">
                            <path
                        ...
                        <g id="hands" class="text-mw-gray" onclick="changeColor(this)">
                            <path
                        ...
                        <g id="forearms" class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                            onclick="changeColor(this)">
                            <path
                        ...
                        <g class="bodymap active:text-mw-red-700 text-mw-red" id="biceps"
                            onclick="changeColor(this)">
                            <path
                        ...
                        <g id="front-shoulders" class="bodymap active:text-mw-red-700 text-mw-red"
                            onclick="changeColor(this)">
                            <path
                        ...
                        <g id="chest" class="bodymap active:text-mw-red-700 text-mw-red"
                            onclick="changeColor(this)">
                            <path
                        ...
                        <g id="traps" class="bodymap active:text-mw-red-700 text-mw-red"
                            onclick="changeColor(this)">
                            <path
                        ...
                        <g id="body" class="body-map__model">
                            <line x1="330.4" y1="504.57" x2="330.4" y2="571.92" fill="none"
                                stroke="#484a68" stroke-linecap="round" stroke-linejoin="round" stroke-width="3.46">
                            </line>
                            <line x1="330.17" y1="504.57" x2="330.17" y2="571.92" fill="none"
                                stroke="#484a68" stroke-linecap="round" stroke-linejoin="round" stroke-width="3.46">
                            </line>
                            <line x1="330.05" y1="504.57" x2="330.05" y2="571.92" fill="none"
                                stroke="#484a68" stroke-linecap="round" stroke-linejoin="round" stroke-width="3.46">
                            </line>
                            ...
                            <path d="M298.53,428.4c6.43-.76,15.03-1.74,22.89-1.63,7.86.11,8.64,5.42,8.64,13.89"
                                fill="none" stroke="#484a68" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="3.46"></path>
                            <line x1="330.29" y1="504.57" x2="330.29" y2="571.92" fill="none"
                                stroke="#484a68" stroke-linecap="round" stroke-linejoin="round" stroke-width="3.46">
                            </line>
                        ...
                        <g id="shoulders" class="hidden">
                            <ellipse id="hover-2" data-name="hover" cx="441.13" cy="261.13" rx="24.71"
                                ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                            <ellipse id="hover" cx="219.33" cy="261.13" rx="24.71" ry="25.24"
                                fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                            <ellipse cx="441.13" cy="261.13" rx="12.04" ry="12.3"
                                fill="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="3.46"></ellipse>
                            <ellipse cx="219.33" cy="261.13" rx="12.04" ry="12.3"
                                fill="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="3.46"></ellipse>
                        </g>
                        <g id="elbow" class="hidden">
                            <ellipse id="hover-3" data-name="hover" cx="118.6" cy="412.77" rx="24.71"
                                ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                            <ellipse id="hover-7" data-name="hover" cx="541.86" cy="412.77" rx="24.71"
                                ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                            <ellipse cx="541.86" cy="412.77" rx="12.04" ry="12.3"
                                fill="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="3.46"></ellipse>
                            <ellipse cx="118.6" cy="412.77" rx="12.04" ry="12.3"
                                fill="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="3.46"></ellipse>
                        </g>
                        <g id="wrist" class="hidden">
                            <ellipse id="hover-4" data-name="hover" cx="42.41" cy="531.02" rx="24.71"
                                ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                            <ellipse id="hover-8" data-name="hover" cx="618.05" cy="531.02" rx="24.71"
                                ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                            <ellipse cx="618.05" cy="531.02" rx="12.04" ry="12.3"
                                fill="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="3.46"></ellipse>
                            <ellipse cx="42.41" cy="531.02" rx="12.04" ry="12.3"
                                fill="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="3.46"></ellipse>
                        </g>
                        <g id="hips" class="hidden">
                            <ellipse id="hover-6" data-name="hover" cx="412.75" cy="523.37" rx="24.71"
                                ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                            <ellipse id="hover-5" data-name="hover" cx="247.71" cy="523.37" rx="24.71"
                                ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                            <ellipse cx="412.75" cy="523.37" rx="12.04" ry="12.3"
                                fill="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="3.46"></ellipse>
                            <ellipse cx="247.71" cy="523.37" rx="12.04" ry="12.3"
                                fill="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="3.46"></ellipse>
                        </g>
                        <g id="knees" class="hidden">
                            <ellipse id="hover-10" data-name="hover" cx="419.37" cy="874.7" rx="24.71"
                                ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                            <ellipse id="hover-9" data-name="hover" cx="241.09" cy="874.7" rx="24.71"
                                ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                            <ellipse cx="419.37" cy="874.7" rx="12.04" ry="12.3"
                                fill="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="3.46"></ellipse>
                            <ellipse cx="241.09" cy="874.7" rx="12.04" ry="12.3"
                                fill="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="3.46"></ellipse>
                        </g>
                        <g id="ankles" class="hidden">
                            <ellipse id="hover-11" data-name="hover" cx="221.14" cy="1105.65" rx="24.71"
                                ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                            <ellipse id="hover-12" data-name="hover" cx="439.32" cy="1105.65" rx="24.71"
                                ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                            <ellipse cx="439.32" cy="1105.65" rx="12.04" ry="12.3"
                                fill="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="3.46"></ellipse>
                            <ellipse cx="221.14" cy="1105.65" rx="12.04" ry="12.3"
                                fill="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="3.46"></ellipse>
                        </g>
                    </svg>
                ...
                <div class="col-md-6 form-group mb-3">
                    ...
                    <svg viewBox="0 0 660.46 1206.46" fill="none" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <g id="glutes" class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                            onclick="changeColor(this)">
                            <path
                        ...
                        <g id="triceps" class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                            onclick="changeColor(this)">
                            <path
                        ...
                        <g id="lats" class="bodymap active:text-mw-red-700 text-mw-red"
                            onclick="changeColor(this)">
                            <path
                        ...
                        <g id="traps-middle" class="bodymap active:text-mw-red-700 text-mw-red"
                            onclick="changeColor(this)">
                            <path
                        ...
                        <g id="rear-shoulders" class="bodymap active:text-mw-red-700 text-mw-red"
                            onclick="changeColor(this)">
                            <path
                        ...
                        <g id="body" class="body-map__model">
                            ...
                            <path d="M102.63,368.78c-11.91,35.01,10.78,12.73,19.35,18,8.73,5.36-8.23,50.09,34.96,11.52"
                                fill="none" stroke="#484a68" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="3.52"></path>
                            <path d="M223.86,211.87c23.48-.79,35.4,13.24,40.81,19.16,12.57,13.74,20.72.94,65.59.94"
                                fill="none" stroke="#484a68" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="3.52"></path>
                            ...
                            <path
                                ...
                                fill="none" stroke="#484a68" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="3.52"></path>
                            <line x1="330.26" y1="553.71" x2="330.26" y2="614.06" fill="none"
                                stroke="#484a68" stroke-linecap="round" stroke-linejoin="round" stroke-width="3.52">
                            </line>
                            <path
                        ...
                        <g id="ankles" class="hidden">
                            <ellipse id="hover-9" data-name="hover" cx="445.81" cy="1119.64" rx="25.53"
                                ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                            <ellipse id="hover-8" data-name="hover" cx="214.71" cy="1119.64" rx="25.53"
                                ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                            <ellipse cx="214.71" cy="1119.64" rx="12.44" ry="12.3"
                                fill="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="3.52"></ellipse>
                            <ellipse cx="445.81" cy="1119.64" rx="12.44" ry="12.3"
                                fill="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="3.52"></ellipse>
                        </g>
                        <g id="knees" class="hidden">
                            <ellipse id="hover-7" data-name="hover" cx="237.16" cy="879.63" rx="25.53"
                                ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                            <ellipse id="hover-10" data-name="hover" cx="423.36" cy="879.63" rx="25.53"
                                ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                            <ellipse cx="423.36" cy="879.63" rx="12.44" ry="12.3"
                                fill="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="3.52"></ellipse>
                            <ellipse cx="237.16" cy="879.63" rx="12.44" ry="12.3"
                                fill="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="3.52"></ellipse>
                        </g>
                        <g id="wrist" class="hidden">
                            <ellipse id="hover-6" data-name="hover" cx="30.54" cy="548.63" rx="25.53"
                                ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                            <ellipse id="hover-11" data-name="hover" cx="629.98" cy="548.63" rx="25.53"
                                ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                            <ellipse cx="629.98" cy="548.63" rx="12.44" ry="12.3"
                                fill="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="3.52"></ellipse>
                            <ellipse cx="30.54" cy="548.63" rx="12.44" ry="12.3"
                                fill="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="3.52"></ellipse>
                        </g>
                        <g id="elbow" class="hidden">
                            <ellipse id="hover-5" data-name="hover" cx="119.84" cy="396.23" rx="25.53"
                                y="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                            <ellipse id="hover-12" data-name="hover" cx="540.68" cy="396.23" rx="25.53"
                                ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                            <ellipse cx="540.68" cy="396.23" rx="12.44" ry="12.3"
                                fill="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="3.52"></ellipse>
                            <ellipse cx="119.84" cy="396.23" rx="12.44" ry="12.3"
                                fill="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="3.52"></ellipse>
                        </g>
                        <g id="upper-spine" class="hidden">
                            <ellipse id="hover" cx="330.26" cy="209.3" rx="25.53" ry="25.24"
                                fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                            <ellipse cx="330.26" cy="209.3" rx="12.44" ry="12.3"
                                fill="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="3.52"></ellipse>
                        </g>
                        <g id="scapula" class="hidden">
                            <ellipse id="hover-2" data-name="hover" cx="240.12" cy="271.32" rx="25.53"
                                ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                            <ellipse id="hover-3" data-name="hover" cx="420.4" cy="271.32" rx="25.53"
                                ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                            <ellipse cx="420.4" cy="271.32" rx="12.44" ry="12.3"
                                fill="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="3.52"></ellipse>
                            <ellipse cx="240.12" cy="271.32" rx="12.44" ry="12.3"
                                fill="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="3.52"></ellipse>
                        </g>
                        <g id="lower-spine" class="hidden">
                            <ellipse id="hover-4" data-name="hover" cx="330.26" cy="491.77"
                                rx="25.53" ry="25.24" fill="url(#jointradial)" opacity="1"
                                stroke-width="0"></ellipse>
                            <ellipse cx="330.26" cy="491.77" rx="12.44" ry="12.3"
                                fill="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="3.52"></ellipse>
                        </g>
                    </svg>
    ...
    <script>
        function changeColor(element) {
            ...
            const currentColor = element.querySelector('path').getAttribute('fill');
            const newColor = (currentColor === 'rgb(254, 91, 127)') ? 'rgb(0, 0, 0)' : 'rgb(254, 91, 127)';
