            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">
                        Gestión de Días
                        <small class="ml-3 mr-3">|</small><small>Crear Día</small>
                    </h1>
                </div>
                <div class="col-sm-6">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row my-5 justify-content-center">
                    <form name="day-form" id="day-form" action="{{ route('days.store') }}" method="POST" class="col-md-8">
                        @csrf
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" placeholder="Ej: Lunes, Martes" required
                                name="nombre" type="text" id="day-name">
                        </div>
                        <div class="row mt-3">
                            <div class="col-12 text-right">
                                <button type="submit" class="btn btn-info">
                                    <i class="fa fa-save"></i> Agregar Día
                                </button>
